...
## 🛡 Installation
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)]([https://Rehansaputradewantoro/Fsub/file-deploy.html](https://heroku.com/deploy?template=https://github.com/Rehansaputradewantoro/Fsubot.app/file-deploy))</br>
...
* `CUSTOM_CAPTION` letakkan teks teks Kustom Anda jika Anda ingin Mengatur Teks Kustom, Anda dapat menggunakan HTML dan <a href='https://github.com/Rehansaputradewantoro/Fsub/blob/main/README.md#custom_caption'>fillings</a> untuk pemformatan (hanya untuk dokumen)
...
## 🏷 Support   
- Follow Channel [@Revanstoreya](https://t.me/Revanstoreya) untuk info Update bot 
- Gabung Group [@Revansupport](https://t.me/Revansupport) untuk diskusi, pelaporan bug, dan bantuan tentang File-Sharing-Man.
...
[FILE-SHARING-BOT](https://github.com/Rehansaputradewantoro/Fsub/) is Free Software: You can use, study share and improve it at your
